...
To run the app, clone the repository, navigate to the project and run `python -m "SimpleHTTPServer" 8000`, the open a browser and go to `localhost:8000`. If you just want to check it out real quick, it is also live here.
